...
<p>5. 个人博客或微博，当你注册以后，就拥有以你用户名为开头的博客域名：http://你的用户名.jdon.com
     在个人博客中发表文章也同时出现在相应的论坛中，约束作者发表与论坛内容性质一致的专业博客。
   6.无论在论坛或博客发帖，可使用类似微博或Twitter语法，如帖子内容中输入"@用户名 "，将给该用户发一个私信，通知他你在这个帖子提到了他。 
<p>7. 如果你发贴超过10篇以上，所发文章属于正确的分类标签，能够在首页home.jsp得到自动推荐。
<p>8. 站内消息，使用AJAX异步更新技术，可以实现两个用户在线实时聊天交流。
<p>9. 发表新文章时，会出现标签输入，输入本文章的关键字TAG，如果已经存在，会自动弹出可选标签，最好选择已经存在的标签，否则就不要输入标签，由管理员来补充。</br>
<p>10. 发表或回复输入内容时，系统定时将输入内容复制到你电脑的粘贴板clipboard中(IE会自动弹出提示选择Yes)，如果提交出错或出现意外输入内容丢失了，可以通过Ctrl和V键从粘贴板中恢复出来。</p>
<p>11. 关注订阅功能：你对某个主题讨论或标签话题有兴趣时，可以加入你的收藏关注，并可以设置：当它们有新内容，会自动发站内消息或邮件通知你。</p>
<p>12.登录时激活'自动登录'，当有人给你消息时，只要访问本系统就会自动通知您!</p>
