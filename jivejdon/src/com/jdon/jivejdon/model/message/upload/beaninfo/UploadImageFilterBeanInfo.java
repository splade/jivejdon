 ...
 *
 */
package com.jdon.jivejdon.model.message.upload.beaninfo;

import com.jdon.jivejdon.model.message.output.beanutil.FilterBeanInfo;
import com.jdon.jivejdon.model.message.upload.UploadImageFilter;

public class UploadImageFilterBeanInfo extends FilterBeanInfo {
	public static final String[] PROPERTY_NAMES = { "imageShowUrl", "imageShowInHtmlUrl", "imageShowFileName"};
