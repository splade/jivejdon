...
public class UploadRepositoryDao implements UploadRepository {
	...
	public UploadRepositoryDao(SequenceDao sequenceDao, UploadFileDao uploadFileDao, PropertyDao propertyDao, ContainerUtil containerUtil) {
	...
	/* (non-Javadoc)
	 * @see com.jdon.jivejdon.repository.UploadRepository#getUploadFiles(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.jdon.jivejdon.repository.UploadRepository#getSingleUploadFile(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.jdon.jivejdon.repository.UploadRepository#getUploadFiles(int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see com.jdon.jivejdon.repository.UploadRepository#getUploadFile(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.jdon.jivejdon.repository.UploadRepository#saveAllUploadFiles(java.lang.String, java.util.Collection)
	 */
	...
	/* (non-Javadoc)
	 * @see com.jdon.jivejdon.repository.UploadRepository#updateAllUploadFiles(java.lang.String, java.util.Collection)
	 */
	...
	/* (non-Javadoc)
	 * @see com.jdon.jivejdon.repository.UploadRepository#deleteAllUploadFiles(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.jdon.jivejdon.repository.UploadRepository#deleteUploadFile(java.lang.String)
	 */
