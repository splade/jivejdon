...
public class TagDaoSql implements TagDao {
	private final static Logger logger = Logger.getLogger(TagDaoSql.class);
	...
	/* (non-Javadoc)
	 * @see com.jdon.jivejdon.dao.sql.TagDao#createThreadTag(com.jdon.jivejdon.model.ThreadTag)
	 */
	...
	/* (non-Javadoc)
	 * @see com.jdon.jivejdon.dao.sql.TagDao#delThreadTag(com.jdon.jivejdon.model.ForumThread)
	 */
	...
	/* (non-Javadoc)
	 * @see com.jdon.jivejdon.dao.sql.TagDao#addThreadTag(com.jdon.jivejdon.model.ThreadTag, com.jdon.jivejdon.model.ForumThread)
	 */
	...
	/* (non-Javadoc)
	 * @see com.jdon.jivejdon.dao.sql.TagDao#delThreadTag(com.jdon.jivejdon.model.ThreadTag, com.jdon.jivejdon.model.ForumThread)
	 */
	...
	public Collection<Long> searchTitle(String s) {
		...
		//		String LOAD_SQL = "SELECT title FROM tag WHERE locate('"+ s +"', title) > 0 order " +
	...
	/* (non-Javadoc)
	 * @see com.jdon.jivejdon.dao.sql.TagDao#getTaggedThread(java.lang.Long, int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see com.jdon.jivejdon.dao.sql.TagDao#updateThreadTag(com.jdon.jivejdon.model.ThreadTag)
	 */
