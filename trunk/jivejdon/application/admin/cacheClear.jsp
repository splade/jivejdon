...
<%@page import="com.jdon.jivejdon.service.util.ContainerUtil"%>
<%@page import="com.jdon.controller.WebAppUtil"%>
<%@page import="com.jdon.jivejdon.manager.throttle.ThrottleManagerIF"%>
...
ThrottleManagerIF th = (ThrottleManagerIF)WebAppUtil.getComponentInstance("throttleManager", request);
th.clear();
%>
<h3>缓存清除复位成功</h3>
