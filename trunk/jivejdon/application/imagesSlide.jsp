...
<logic:iterate  id="image" name="imageListForm" property="list">
   ...
   xsImgs[<%=i%>] =  "<%=request.getContextPath()%>/img/"+ "<bean:write name="image" property="imageId" />"+"-"+"<bean:write name="image" property="oid" />";
       <logic:equal name="forumMessage" property="root" value="true">
                xsImgLinks[<%=i%>] = '<%=request.getContextPath()%>/thread/<bean:write name="forumMessage" property="forumThread.threadId"  />';                    
       </logic:equal>
       <logic:equal name="forumMessage" property="root" value="false">
                xsImgLinks[<%=i%>] = '<%=request.getContextPath()%>/thread/nav/<bean:write name="forumMessage" property="forumThread.threadId"  />/<bean:write name="forumMessage" property="messageId" />#<bean:write name="forumMessage" property="messageId" />'; 
       </logic:equal>                          
