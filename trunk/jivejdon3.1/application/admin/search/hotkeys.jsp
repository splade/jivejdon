...
<logic:iterate id="prop" name="propertysForm" property="propertys" >
 ...
 <tr  bgcolor="#eeeeee">
    ...
    <tr>
    <td>链接：<input type="text" name='<%= "property[" + i + "].value" %>' value='<bean:write name="prop" property="value"/>'   size="40"/></td>
  </tr>
  <% i++; %>
  </logic:notEmpty>
</logic:iterate>
...
var w = <%=i %>;
function setValue(){
        var insert = "<table bgcolor=#cccccc border=0 width=500 ><tr><td><table  border=0 width=100%>  <tr  bgcolor=#eeeeee>    <td rowspan=2>关键词</td>    <td>名称：<input type='text' name='property[" 
	+ w + 
