...
<div style="position: relative; font-size: smaller; padding-top: 5px;"><b>&nbsp;获取新密码&nbsp;</b></div>
</div>
...
<logic:notPresent name="accountForm">
    ...
    <br>
  <tr><td>
    密码问题：</td><td><html:text property="passwdtype"/>
  </td></tr>
  <tr><td>
    密码答案：</td><td><html:text property="passwdanswer"/>
  </td></tr>
